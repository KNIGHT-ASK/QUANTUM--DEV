...
exports.MolecularHamiltonian = void 0;
...
class MolecularHamiltonian {
     ...
     */
    static getH2Hamiltonian(bondLength = 0.735) {
     ...
     */
    static toQubitHamiltonian(molHam) {
    ...
    static buildQubitMatrix(qubitHam) {
        ...
        for (const term of qubitHam.pauliStrings) {
            ...
            for (const P of paulis) {
                for (let i = 0; i < dim; i++) {
                    for (let j = 0; j < dim; j++) {
                        H[i][j] = math.add(H[i][j], math.multiply(coeff, P[i][j]));
                    }
                }
            }
        }
     ...
     */
    static getGroundStateEnergy(molecule, bondLength) {
...
exports.MolecularHamiltonian = MolecularHamiltonian;
//# sourceMappingURL=MolecularHamiltonian.js.map