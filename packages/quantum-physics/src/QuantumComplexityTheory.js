...
exports.QuantumComplexityTheory = void 0;
class QuantumComplexityTheory {
     ...
     */
    queryComplexity(problem, quantum) {
     ...
     */
    isQuantumSupremacy(quantumTime, classicalTime, qubits) {
        const exponentialGap = classicalTime / quantumTime;
        return exponentialGap > Math.pow(2, qubits * 0.1);
    }
}
exports.QuantumComplexityTheory = QuantumComplexityTheory;
//# sourceMappingURL=QuantumComplexityTheory.js.map